...
# configurations
img_folder = "/imatge/lsalgueiro/projects/remote_sensing/SpaceNet/dataset/DIV2K/DIV2K_valid_HR_sub/*"   #'/mnt/SSD/xtwang/BasicSR_datasets/DIV2K800/DIV2K800/*'  # glob matching pattern
lmdb_save_path = "/imatge/lsalgueiro/projects/remote_sensing/SpaceNet/dataset/DIV2K/DIV2K_valid_HR_sub.lmdb" #'/mnt/SSD/xtwang/BasicSR_datasets/DIV2K800/DIV2K800.lmdb'  # must end with .lmdb
